...
export const translations = {
  en: {
    ...
    consultDescription: 'Request pure AI recommendations without executing any live orders.',
    consultSymbols: 'Accepted Pairs',
    consultSymbolsHint: 'Separate tickers with commas, spaces, or new lines (e.g., BTCUSDT, ETH/USDT).',
    consultSymbolsPlaceholder: 'BTCUSDT, ETHUSDT, SOLUSDT',
    consultLeverage: 'Leverage',
    consultBalance: 'Virtual Balance (USDT)',
    consultSave: 'Save Settings',
    consultRequest: 'Request Advice',
    consultLastSaved: 'Last saved',
    consultNeedTrader: 'Select a trader to enable consultation mode.',
    consultResultTitle: 'Latest AI Advice',
    consultNoResult: 'No advice yet. Configure your pairs and click Request.',
    consultAdviceTimestamp: 'Generated at',
    consultCotTitle: 'AI Chain of Thought',
    consultDecisionsCount: '{count} suggested actions',
    consultErrorNoSymbols: 'Please enter at least one trading pair.',
    consultNoteLabel: 'Additional Context',
    consultNotePlaceholder: 'E.g., “FOMC just ended, keep leverage under 10x and watch BTC.”',
    consultNoteHint: 'Notes are saved with every request so you can continue the conversation anytime.',
    consultNoteUsed: 'AI generated the advice referencing:',
    consultHistorySubtitle: 'Persisted dialogue with the AI. Load any turn to review details.',
    consultConversationSend: 'Send Follow-up',
    consultHistoryExpand: 'Show more',
    consultHistoryCollapse: 'Collapse',
    consultHistoryTitle: 'Consultation History',
    consultHistoryEmpty: 'No consultation requests recorded yet.',
    consultHistoryLoad: 'Load Result',
    autoModeOn: 'Auto Trading: ON',
    autoModeOff: 'Auto Trading: OFF',
    autoModeHint: 'Default to consultation-only mode until you enable auto trading manually.',
  ...
  zh: {
    ...
    running: '运行中',
    stopped: '已停止',
    consultationMode: '咨询模式',
    consultDescription: '点击请求仅返回AI建议，不会真实下单。',
    consultSymbols: '允许交易对',
    consultSymbolsHint: '支持逗号、空格或换行分隔，如 BTCUSDT、ETH/USDT。',
    consultSymbolsPlaceholder: 'BTCUSDT, ETHUSDT, SOLUSDT',
    consultLeverage: '杠杆倍数',
    consultBalance: '参考余额（USDT）',
    consultSave: '保存设置',
    consultRequest: '请求AI建议',
    consultLastSaved: '上次保存',
    consultNeedTrader: '请选择一个Trader以使用咨询模式。',
    consultResultTitle: '最新AI建议',
    consultNoResult: '尚无AI建议，请先配置交易对并点击请求。',
    consultAdviceTimestamp: '生成时间',
    consultCotTitle: 'AI思维链',
    consultDecisionsCount: '共 {count} 条建议',
    consultErrorNoSymbols: '请至少填写一个交易对。',
    consultNoteLabel: '额外说明',
    consultNotePlaceholder: '例如：凌晨有FOMC，降低仓位、只关注BTC与ETH…',
    consultNoteHint: '这些说明会随请求持久保存，方便你重启后继续追问。',
    consultNoteUsed: 'AI 本次结果已参考：',
    consultHistorySubtitle: '与AI的对话会长期保存，点击即可回看详情。',
    consultConversationSend: '发送追问',
    consultHistoryExpand: '展开',
    consultHistoryCollapse: '收起',
    consultHistoryTitle: '咨询历史',
    consultHistoryEmpty: '暂无咨询记录。',
    consultHistoryLoad: '回显结果',
    autoModeOn: '自动交易：已开启',
    autoModeOff: '自动交易：咨询模式',
    autoModeHint: '默认停留在咨询模式，手动开启后才会循环下单。',
