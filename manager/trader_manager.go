...
func (tm *TraderManager) AddTrader(cfg config.TraderConfig, coinPoolURL string, maxDailyLoss, maxDrawdown float64, stopTradingMinutes int, leverage config.LeverageConfig) error {
	...
	traderConfig := trader.AutoTraderConfig{
		...
		Name:                     cfg.Name,
		AIModel:                  cfg.AIModel,
		SystemPromptPath:         cfg.PromptPath,
		...
		ProfitGuardAnchorPct:     cfg.ProfitGuardAnchorPct,
		ProfitGuardRetainRatio:   cfg.ProfitGuardRetainRatio,
		ProfitGuardMinRetainUSD:  cfg.ProfitGuardMinRetainUSD,
		...
		EntryATRBufferMultiplier: cfg.GetEntryATRBufferMultiplier(),
	...
	if cfg.RiskReviewEnabled != nil {
		traderConfig.RiskReviewEnabled = *cfg.RiskReviewEnabled
	}
